    ...
    <section className="py-10 md:py-15">
      <MaxWidthWrapper>
        ...
        <Paragraph className="text-center py-5 w-full md:w-[80%] flex mx-auto">
          Supper Shop offers a cozy and inviting atmosphere where you can enjoy
          a delicious variety of late-night meals, perfect for satisfying
          cravings after hours.
        </Paragraph>
        <Carousel>
          <CarouselContent>
